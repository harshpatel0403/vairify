    ...
    <div className="relative mx-auto text-gray-600">
      {language === "true" && (
        <div className="relative w-full mx-auto flex flex-row justify-center items-center">
          <button type="submit" className="absolute left-12 top-3">
            <FontAwesomeIcon
              icon={faSearch}
              className="dataguard-services-search-icon"
            />
          </button>
          <input
            className={`w-full border-2 border-gray-300 h-10 pl-10 pr-8 text-md focus:outline-none ${
              classname ? classname : ""
      ...
      {language !== "true" && (
        <div className="w-full mx-auto flex flex-row justify-center items-center">
          <input
            className={`w-full border-2 border-gray-300 h-10 pr-8 text-md focus:outline-none ${
              classname ? classname : ""
            } ${bgColor ? `bg-${bgColor}` : "bg-white"} ${
              rounded ? `rounded-${rounded}` : "rounded-lg"
            }`}
