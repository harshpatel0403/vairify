        ...
        <div className="w-full mx-auto flex flex-col justify-center items-center relative">
            <div className='w-full mx-auto flex flex-row justify-center items-center mt-6'>
                <div className='flex flex-col justify-center items-center mr-6'>
                    ...
                    <span className='font-bold text-[16px] text-white change-font-family'>{isTimerRunning ? 'Pause' : 'Start'}</span>
                </div>
                <div className='w-[96px] h-[96px] bg-[#DB3002] rounded-[100%] flex items-center justify-center mr-6'><span className='font-bold text-[24px] text-white change-font-family'>ALARM</span></div>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <span className='font-bold text-[16px] text-white change-font-family'>Resume</span>
                </div>
            </div>
        </div>
      )
          ...
          <div className="w-full mx-auto digital-timer-container">
            <div className="timer-display-container">
              <div className="elapsed-time-container">
                <p className="timer-state change-font-family">Date time</p>
                <h1 className="elapsed-time change-font-family">
