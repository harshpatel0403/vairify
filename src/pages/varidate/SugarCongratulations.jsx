            ...
            <div className="w-full mx-auto flex flex-col justify-center items-center">
                <div className='w-full mx-auto flex flex-row justify-between items-start mt-2'>
                    ...
                    <div className='w-[120px] relative'>
                        <div style={{ left: '10px', bottom: '65px' }} className='absolute w-full h-full rounded-full'><img src={'/images/Ellipse 121.png'} alt="Sugar" /></div>
                        <div style={{ right: '0px', top: '25px' }} className='absolute'><img src={'/images/SugarIcon2.png'} alt="Sugar Icon Second" /></div>
                    </div>
                    <div>
                        <div><span className='text-[18px] text-[#040C50] font-bold'> TruRevu</span></div>

                        <div className='flex flex-row justify-center items-center'>

                            <FontAwesomeIcon icon={faStar} color="#E1AB3F" className='text-[10px] margin-right-5' /><FontAwesomeIcon icon={faStar} color="#E1AB3F" className='text-[10px] margin-right-5' /><FontAwesomeIcon icon={faStar} color="#E1AB3F" className='text-[10px] margin-right-5' /><FontAwesomeIcon icon={faStar} color="#E1AB3F" className='text-[10px] margin-right-5' /><FontAwesomeIcon icon={faStar} color="#E1AB3F" className='text-[10px] margin-right-5' />
                            <span className='text-[15px] text-[#040C50] font-bold'>5.0</span></div>
                    </div>
                </div>
                <div className='w-full mx-auto flex flex-col justify-center items-center mt-2'>
                    <span className='font-bold text-[24px]'>Sugar</span>
                </div>
                <div className='inner-content-part-country pb-2'>


                    <div className='w-full mx-auto flex flex-col justify-center items-center mt-4'>
                        <div className='w-[126px] h-[184px]'><img src={'/images/CongratulationKiss.png'} alt="Congratulations Kiss Icon" /></div>
                    </div>
                    <div className='w-full mx-auto flex flex-col justify-center items-center mt-2'>
                    ...
                    <div className='w-full max-w-[278px] mx-auto flex flex-col justify-center items-center mt-6 bg-gradient-to-b from-[#0247FF] to-[#FFFFFF] rounded-[25px] px-6 py-4 text-white'>
                        ...
                        <div className='w-full mx-auto flex flex-row justify-center items-center flex-wrap mt-2'>
                            <div className='w-[100px] mr-6 mb-0'><Button onClick={() => navigateToVairidate()} text="Yes" className={'bg-gradient-to-b from-[#02227E] to-[#0247FF] text-white font-bold text-[15.24px] rounded-[25px]'} size="30px" /></div>
                            <div className='w-[100px] mb-0'><Button onClick={() => navigateToVairidate()} text="No" className={'bg-gradient-to-b from-[#02227E] to-[#0247FF] text-white bg-transparent font-bold text-[15.24px] rounded-[25px]'} size="30px" /></div>
                        </div>
                    </div>
                </div>
            </div>
