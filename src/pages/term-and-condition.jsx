    ...
    <div className="main-container flex flex-col justify-start">
      ...
      >
        ...
        <p className="font-bold px-4 w-full max-w-full mb-2">
          ...
          and use of the{" "}
          <a href="https://vairify.io" className="underline text-blue-700">
            https://vairify.io
          </a>{" "}
          website and any related services, including all media forms, media
          channels, mobile websites, or mobile applications associated therewith
          (collectively, the "Site"). By accessing and using the Site, you
        ...
        <p className="font-bold px-4 w-full max-w-full mb-2">
          ...
          including but not limited to lost profit, lost revenue, loss of data,
          or other such damages, arising from your use of the Site, regardless
          of the advisement of the possibility of such damages. Our total
          liability to you for any cause whatsoever, and regardless of the form
          of the action, will be limited to the lesser of the amount paid, if
          any, by you to us, or [insert any specific limitation amount here if
          applicable]. Certain jurisdictions do not allow limitations on implied
        ...
        <p className="font-bold px-4 w-full max-w-full mb-2">
          ...
          enforceability of any remaining provisions. No joint venture,
          partnership, employment, or agency relationship exists between you and
          VAIRIFY.IO as a result of these Terms or use of the Site. These Terms
        ...
        <p className="font-bold px-4 w-full max-w-full mb-2">
          ...
          party due to or arising out of your Contributions, use of the Site,
          breach of these Terms, any breach of your representations and
          warranties outlined in these Terms, your violation of the rights of a
          third party, including but not limited to intellectual property
          rights, or any overt harmful act toward any other user of the Site
          with whom you connected via the Site. We reserve the right, at your
          expense, to assume the exclusive defense and control of any matter for
          which you are required to indemnify us, and you 4 agree to cooperate
          with our defense of such claims. We will make reasonable efforts to
        ...
        <p className="font-bold px-4 w-full max-w-full mb-2">
          ...
          disclosures, and other communications we provide electronically, via
          email, and on the Site, satisfy any legal requirement that such
          communication be in writing. You agree to the use of electronic
          ...
          or completed by us or through the Site. You hereby waive any rights or
          requirements under any laws in any jurisdiction which require an
