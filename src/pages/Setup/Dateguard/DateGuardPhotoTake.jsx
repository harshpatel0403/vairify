...
export default function DateGuardPhotoTake() {
  ...
  const handleSubmit = async () => {
    try {
      if (!file) {
        toast.error(t("dateguardphototake.uploadFileError"));
        return;
      }
      setLoading(true);
      ...
      navigate(
        `/dateguard/count-up/${params?.appointmentId}/${params?.groupId}`
      );
    } catch (error) {
      console.log(error);
    ...
    return (
      <div className="container py-[48px]">
        <div className="w-full mx-auto flex flex-col justify-center items-center sm:gap-[48px] gap-[24px]">
          <h6 className="text-[28px] text-center font-semibold text-white ">
             {t("dateguardphototake.cameraNotFoundTitle")}
          </h6>
          <img
            src="/images/face-verification/camera-not-found.svg"
          ...
          <p className="text-[18px] max-w-[90%] md:max-w-[70%] text-center font-medium text-[#E43530]">
            {t("dateguardphototake.cameraNotFoundMsg")}
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="container ">
      <div className="md:mb-0 sm:mb-[30px] mb-[16px]">
        <PageTitle title={t("dateguardphototake.pageTitle")} />
      </div>
      <div className="w-full mx-auto flex flex-col justify-center items-center ">
        ...
        <div className="w-full mx-auto flex items-center justify-center mt-2 max-w-[400px]">
          <div className="flex-1 flex items-center justify-center">
            {imgSrc ? (
              <img
                src={imgSrc}
                alt="Date Guard Success Changed Code"
              ...
              <div className="relative">
                ...
                />
                <img
                  src="/images/face-verification/camera-vector.svg"
                  className="left-[5%] top-[5%] absolute z-[100]"
                />
                <img
                  src="/images/face-verification/camera-vector.svg"
                  className="right-[5%] top-[5%] absolute z-[100] rotate-[90deg]"
                />
                <img
                  src="/images/face-verification/camera-vector.svg"
                  className="left-[5%] bottom-[5%] absolute z-[100] rotate-[-90deg]"
                />
                <img
                  src="/images/face-verification/camera-vector.svg"
                  className="right-[5%] bottom-[5%] absolute z-[100]  rotate-[-180deg]"
                />
              </div>
            )}
          </div>
        ...
        {file && (
          <div className="flex flex-col items-center mt-4">
            ...
            <Button
              onClick={handleRetry}
              text={t("dateguardphototake.retry")}
        ...
        <div className="w-full mx-auto flex flex-col justify-center items-start mt-10 mb-10">
          <label className="text-white font-normal text-base mb-1">
             {t("dateguardphototake.messageLabel")}
          </label>
          <div className="w-full mx-auto flex flex-row justify-center items-center">
            <textarea
              ...
              placeholder={t("dateguardphototake.messagePlaceholder")}
            >
              {message}
            </textarea>
          </div>
