      ...
      <div className="flex flex-col justify-between">
        <div className="mt-2 bg-[#040C50]/[26%] w-full ">
          <h2 className="font-bold py-2 text-[24px] text-[#02227E] font-inter ">
            VAI Membership History
          </h2>
        </div>
        {!VaiMembershipHistoryData?.length && (
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {VaiMembershipHistoryData &&
                VaiMembershipHistoryData?.map((item, index) => {
                  ...
                  return (
                    <div className="sm:w-[100%] max-w-[440px] bg-[#3760CB]  py-[12px] rounded-[20px] border border-gray-100 h-[auto] ">
                          ...
                          <div className="flex-col items-center">
                            <div className="text-left">
                              ...
                              <div className="flex flex-row justify-between items-center">
                                ...
                                <h6 className="text-xs text-white font-roboto font-semibold mb-2">
                                  {UserDetails?.isKycCancelled ? <h6>( Active / cancelled )</h6> : <h6>Active</h6>}
                                </h6>
                              </div>
                            </div>
...
export default KycMembershipHistory;
