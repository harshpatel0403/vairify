        ...
        <div className="bg-[#3760CB] flex flex-col rounded-2xl p-3 border-2 border-white">
          ...
          <div className="flex gap-4 mt-4">
            <Button
              text={"Cancel"}
              className={
                "flex items-center justify-center rounded-full text-white border-[#02227E] border-[1px] from-[#FF0000] to-[#FF0000] h-[23px]"
              }
              size="23px"
            />
            <Button
              text={"Re-post"}
              className={
                "flex items-center justify-center rounded-full text-white border-[#02227E] border-[1px] from-[#0C8A02] to-[#0C8A02] h-[23px]"
              }
              size="23px"
            />
            <Button
              text={"View"}
              className={
                "flex items-center justify-center rounded-full text-white border-[#02227E] border-[1px] from-[#02227E] to-[#02227E] h-[23px]"
              }
              size="23px"
            />
          </div>
