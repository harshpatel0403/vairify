...
const VairifyMembershipPlans = () => {
  ...
  const fetchVairifyPlans = async () => {
    try {
      ...
      setVairifyPlansData(result?.data);
      setLoading(false);
    } catch (error) {
      console.log(error);
      toast.error(error);
    ...
    return (
      <div className="main-container h-full">
        <div className="h-full flex justify-center items-center">
          <p className="font-bold text-[18px] mt-3">Loading...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div
      className="main-container px-0 flex flex-col"
    ...
    >
      <div className="w-full mx-auto flex flex-col flex-auto items-center ">
        <div className="w-full flex flex-col items-center mt-[30px] bg-[#797E9E] py-2 px-[10px]">
          <span className="font-extrabold text-[26px] text-[#040C50]">
        ...
        <div className="w-full">
          <div className="w-full ">
            ...
            <div className="w-full grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 p-5 gap-x-[30px] gap-y-3 overflow-hidden overflow-y-auto rounded-xl inner-card-part vairify-plans-cards-main">
              {vairifyPlansData &&
