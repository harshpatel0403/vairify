    ...
    if (webcamRef.current || true) {
      try {
        ...
        const payload = {
          ...
          companionId: { ...(userDetails?.[0]?.profile?.userId || {}) },
          duration: null,
          endDateTime: null,
        ...
        // companionProfile: userDetails,
        // navigate('/varidate/face-verification', { state: { ...payload, from: 'vai-now' } })
        // navigate('/vai-now/accept', { state: { ...payload, from: 'vai-now' } })
        // console.log(payload, " <=== payload to create appt..");
