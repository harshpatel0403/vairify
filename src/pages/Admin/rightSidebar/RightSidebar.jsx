            ...
            <div className='w-full flex flex-col justify-center items-center'>
                ...
                { 
                    ...
                    <div className='w-full h-[105px] bg-[#0198FE] mt-10 flex flex-row justify-between items-center px-6 py-2'>
                        <img src={import.meta.env.BASE_URL + '/images/AdminNotificaitonUser2.png'} className='mr-5' alt="Adminitrator User Second" />
                        ...
                        <div className='relative'>
                            <div className='w-[53px] h-[50px]'><img className='w-full h-full' src={import.meta.env.BASE_URL + '/images/AdminNotificaiton2.png'} alt="Admin Notification Second" /></div>
                ...
                <div className='flex flex-col justify-center items-center mt-10'>
                    <div className='flex flex-row justify-between items-center mt-10'><div className='w-[80px] h-[80px] mr-5'>{detail == false ? <img src={import.meta.env.BASE_URL + '/images/LocalUser.png'} alt="Local User" /> : <img src={import.meta.env.BASE_URL + '/images/DetailAdComment1.png'} alt="Detail Ad Comment 1" />}</div>{detail == false ? <div className='flex flex-col justify-center items-start'><span className='text-[20px] font-bold text-white'>Local</span><span className='text-[20px] font-bold text-white'>Sugar 87YEB7 Houston TX</span></div> : <div className='text-[20px] font-bold text-white'><span>Hot Rod 87YEB7 Very nice!!!!!!</span></div>}{detail == false && <div><button className='w-[66px] text-[20px] font-bold text-white'>See All</button></div>}</div>
                    <div className='flex flex-row justify-between items-center mt-10'><div className='w-[80px] h-[80px] mr-5'>{detail == false ? <img src={import.meta.env.BASE_URL + '/images/Traveler.png'} alt="Traveler" /> : <img src={import.meta.env.BASE_URL + '/images/DetailAdComment2.png'} alt="Detail Ad Comment 2" />}</div>{detail == false ? <div className='flex flex-col justify-center items-start'><span className='text-[20px] font-bold text-white'>Travelling</span><span className='text-[20px] font-bold text-white'>Crystal 87YEB7 Traveling 8-5</span></div> : <div className='text-[20px] font-bold text-white'><span>Diamond A598E7H BEAUTIFUL!</span></div>}{detail == false && <div><button className='w-[66px] text-[20px] font-bold text-white'>See All</button></div>}</div>
                    <div className='flex flex-row justify-between items-center mt-10'><div className='w-[80px] h-[80px] mr-5'>{detail == false ? <img src={import.meta.env.BASE_URL + '/images/FMTY.png'} alt="FMTY User" /> : <img src={import.meta.env.BASE_URL + '/images/DetailAdComment3.png'} alt="Detail Ad Comment 3" />}</div>{detail == false ? <div className='flex flex-col justify-center items-start'><span className='text-[20px] font-bold text-white'>FMTY</span><span className='text-[20px] font-bold text-white'>Sugar 87YEB7 Portland CA</span></div> : <div className='text-[20px] font-bold text-white'><span>Crystal 8YH67S Thats Hot !!!!!!</span></div>}{detail == false && <div><button className='w-[66px] text-[20px] font-bold text-white'>See All</button></div>}</div>
                    <div className='flex flex-row justify-between items-center mt-10'><div className='w-[80px] h-[80px] mr-5'>{detail == false ? <img src={import.meta.env.BASE_URL + '/images/LocalUser.png'} alt="Local User" /> : <img src={import.meta.env.BASE_URL + '/images/DetailAdComment4.png'} alt="Detail Ad Comment 4" />}</div>{detail == false ? <div className='flex flex-col justify-center items-start'><span className='text-[20px] font-bold text-white'>Local</span><span className='text-[20px] font-bold text-white'>Sugar 87YEB7 Houston TX</span></div> : <div className='text-[20px] font-bold text-white'><span>Big Boy 7890JS7 Thats Hot !!!!!!</span></div>}{detail == false && <div><button className='w-[66px] text-[20px] font-bold text-white'>See All</button></div>}</div>
                    <div className='flex flex-row justify-between items-center mt-10'><div className='w-[80px] h-[80px] mr-5'>{detail == false ? <img src={import.meta.env.BASE_URL + '/images/LocalUser.png'} alt="Local User" /> : <img src={import.meta.env.BASE_URL + '/images/DetailAdComment5.png'} alt="Detail Ad Comment 5" />}</div>{detail == false ? <div className='flex flex-col justify-center items-start'><span className='text-[20px] font-bold text-white'>Local</span><span className='text-[20px] font-bold text-white'>Sugar 87YEB7 Houston TX</span></div> : <div className='text-[20px] font-bold text-white'><span>Onyx 78UR897 I love it how much</span></div>}{detail == false && <div><button className='w-[66px] text-[20px] font-bold text-white'>See All</button></div>}</div>
                </div>
                <div className='relative flex flex-col justify-center items-center mt-10 h-[200px] rounded-xl bg-gradient-to-r from-[#0247FF] to-[#799EFF]'>
                    <img src={import.meta.env.BASE_URL + '/images/EnjoyBackgroundImage.png'} alt="Enjoy" />
                    ...
                    <div className='absolute h-full w-[200px] flex justify-end items-center' style={{right: '10px'}}><img className='h-full' src={import.meta.env.BASE_URL + '/images/AdminDancer.png'} alt='Admin Dancer' /></div>
                </div>
            </div>
        </div>
    );
